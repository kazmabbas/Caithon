...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر كايثون
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات كايثون", data="AOMRDB")],
                [
...
اوامر فارات سورس كايثون @Caithon""",
        buttons=[
...
- سورس كايثون يمتلك اكثر من 100 أمر 
- كايثون هو افضل سورس عربي يتميز بالحماية

قناة الكلايش:  @Caithon1
قناة السورس: @Caithon
قناة المساعدة: @Caithon_HELP
مجموعة المساعدة: @TTYYYPS""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @Caithon1
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس كايثون @Caithon""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
